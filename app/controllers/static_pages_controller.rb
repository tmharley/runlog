class StaticPagesController < ApplicationController
  ...
  def training
    ...
    runs_by_day.each_with_index do |runs, idx|
      ...
      last_week_intensity = Run.last_days_from(7, @end_date - idx.days).pluck(:intensity).compact.sum
      ...
      l4w_intensity = Run.last_days_from(28, @end_date - idx.days).pluck(:intensity).compact.sum / 4.0
      @days << {
        ...
        last_four_weeks: l4w,
        atc: l7d / l4w,
        long_to_total: last_week_miles.any? ? last_week_miles.max / l7d : nil,
        intensity: total_intensity,
        intensity_per_minute: total_intensity / duration_minutes,
        seven_days_intensity: last_week_intensity,
        atc_intensity: last_week_intensity / l4w_intensity
      }
    end
  end
end
